...
class Head extends React.Component {
  render() {
    ...
    // alexq
    const highlightThemeURL= `${this.props.config.baseUrl}css/default.min.css`;
    ...
    return (
      <head>
        ...
        <meta name="generator" content="bicument" />
        ...
        {this.props.config.spmId && (
          <meta
            name="spm_prefix" content={this.props.config.spmId}
          />
        )}
        ...
        <link
          rel="stylesheet"
          href={`${this.props.config.baseUrl}search-box/SearchBox.css`}
        />
        ...
        {this.props.config.scrollToTop && (
          ...
          // alexq
          <script src={`${this.props.config.baseUrl}js/vanilla-back-to-top.min.js`} />
        )}
        {this.props.config.scrollToTop && (
          <script
            dangerouslySetInnerHTML={{
        ...
        <script src={`${this.props.config.baseUrl}js/qin_inject.js`} />
        <script src={`${this.props.config.baseUrl}search-box/SearchBox.js`} />
        {/* <script crossOrigin="true" src="https://unpkg.com/react@16.8.4/umd/react.production.min.js"></script> */}
        {/* <script crossOrigin="true" src="https://unpkg.com/react-dom@16.8.4/umd/react-dom.production.min.js"></script> */}
        {/* // alexq */}
        <script crossOrigin="true" src={`${this.props.config.baseUrl}js/react.production.min.js`}></script>
        <script crossOrigin="true" src={`${this.props.config.baseUrl}js/react-dom.production.min.js`}></script>
      </head>
    );
  }
}
