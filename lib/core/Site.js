          ...
          )}
          {
            this.props.config.search && (
              <React.Fragment>
                <script
                  type="text/javascript"
                  src={`${this.props.config.baseUrl}js/doc_metadata.js`}
                ></script>
                <script
                dangerouslySetInnerHTML={{
                  __html: `
                  const App = document.getElementById("custom-search-box");
                  ReactDOM.render(React.createElement(SearchBox.default, { baseUrl: ${this.props.config.baseUrl}, pageData }), App);
                  `,
                }}
                />
              </React.Fragment>
